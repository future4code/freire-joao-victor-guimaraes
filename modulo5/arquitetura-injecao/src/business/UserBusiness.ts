...
import { User, USER_ROLES,responseOutPutDTO,deleteOutPutDTO, editOutputDTO,getUsersOutputDTO, GetUserInputDTO, singUpInputDTO, loginInputDTO, DeleteUserInputDTO, EditUserInputDTO } from "../models/User"
...
export class UserBusiness {
    ...
    public deleteUser = async (input: DeleteUserInputDTO) => {
        ...
        const response:deleteOutPutDTO = {
